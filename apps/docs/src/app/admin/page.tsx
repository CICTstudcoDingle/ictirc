    ...
    <DocsLayout>
      <article className="prose prose-gray max-w-none hover:prose-a:text-maroon prose-a:transition-colors prose-headings:text-maroon prose-strong:text-maroon">
        ...
        <p className="lead border-l-4 border-maroon/20 pl-4 italic text-gray-600">
          Complete guide for administrators managing the ICTIRC platform. Learn
          how to manage papers, users, archives, and system settings.
        </p>

        <h2>Admin Portal Overview</h2>
        <p>
          The Admin Portal (accessible at <code>http://localhost:3001</code>)
          provides comprehensive tools for managing all aspects of the ICTIRC
          platform.
        </p>
        ...
        <div className="not-prose grid gap-4 my-6">
          <Link href="/admin/dashboard" className="paper-card p-6 group">
            ...
            <p className="text-sm text-gray-600">
              View key metrics, recent submissions, platform statistics, and
              quick actions
            </p>
          </Link>
          ...
          <Link href="/admin/papers" className="paper-card p-6 group">
            ...
            <p className="text-sm text-gray-600">
              Review submissions, assign reviewers, manage publications, and
              track paper workflows
            </p>
          </Link>
          ...
          <Link href="/admin/archives" className="paper-card p-6 group">
            ...
            <p className="text-sm text-gray-600">
              Organize conferences, volumes, and issues. Batch upload papers and
          ...
          <Link href="/admin/users" className="paper-card p-6 group">
            ...
            <p className="text-sm text-gray-600">
              Manage users, assign roles (RBAC), control permissions, and
          ...
          <Link href="/admin/settings" className="paper-card p-6 group">
            ...
            <p className="text-sm text-gray-600">
              Corporate-level system oversight: system health, analytics,
              security controls, and platform management
            </p>
          </Link>
        </div>
        ...
        <p>
          Navigate to <code>http://localhost:3001</code> and log in with your
          admin credentials. You must have DEAN role for full access.
        </p>
        ...
        <ul>
          <li>
            <strong>Reviewing Papers:</strong> Navigate to Papers → Pending to
            review submissions
          </li>
          <li>
            <strong>Managing Users:</strong> Go to Users to view, edit roles, or
            add new users
          </li>
          <li>
            <strong>Creating Archives:</strong> Use Archives → Batch Upload for
            conference proceedings
          </li>
          <li>
            <strong>System Monitoring:</strong> Access Settings → God Mode for
            platform oversight
          </li>
        </ul>
        ...
        <ul>
          <li>
            Regularly review pending submissions to maintain workflow efficiency
          </li>
        ...
        <h2>Need Help?</h2>
        <p>
          For detailed information on specific features, explore the admin guide
          sections:
        </p>
        <ul>
          <li>
            <Link href="/admin/dashboard">Dashboard Guide</Link>
          </li>
          <li>
            <Link href="/admin/papers">Paper Management Guide</Link>
          </li>
          <li>
            <Link href="/admin/archives">Archive System Guide</Link>
          </li>
          <li>
            <Link href="/admin/users">User Management Guide</Link>
          </li>
          <li>
            <Link href="/admin/settings">God Mode Settings Guide</Link>
          </li>
        </ul>
      </article>
    </DocsLayout>
