...
const STEPS = [
  {
    ...
    label: "Submitted",
    icon: FileText,
    description: "Article received by the system.",
  },
  {
    id: 2,
    label: "Initial Screening",
    icon: ShieldCheck,
    description: "Technical and Plagiarism checks.",
  },
  {
    id: 3,
    label: "ID Assigned",
    icon: Settings,
    description: "Official Manuscript ID generated.",
  },
  {
    id: 4,
    label: "Editorial Review",
    icon: UserCheck,
    description: "Peer review and assessment.",
  },
  {
    id: 5,
    label: "Status Notification",
    icon: AlertCircle,
    description: "Decision communicated to authors.",
  },
  {
    id: 6,
    label: "Author Formalities",
    icon: FileText,
    description: "Copyright and final checks.",
  },
  {
    id: 7,
    label: "Final Publication",
    icon: Check,
    description: "Live on IRJICT.",
  },
];
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isCompleted
                      ...
                      : isCurrent
                        ? "bg-white border-maroon text-maroon ring-4 ring-maroon/10"
