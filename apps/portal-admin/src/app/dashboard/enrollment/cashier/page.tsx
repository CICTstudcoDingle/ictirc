      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            {approved.length} student{approved.length !== 1 ? "s" : ""} awaiting
            payment. Payments are recorded in the cict-admin system.
          </p>
        </div>
      </div>
      ...
      {approved.length === 0 ? (
        <div className="bg-white border border-gray-200 rounded-xl p-12 text-center text-gray-400 shadow-sm">
          ...
          <p className="text-base font-medium">
            No approved enrollments awaiting payment.
          </p>
          <p className="text-xs mt-2">
            Approved students are sent to the cict-admin cashier for payment
            posting.
          </p>
        </div>
      ) : (
