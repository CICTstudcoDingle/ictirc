    ...
    <div className="flex flex-wrap gap-3 items-center w-full">
      ...
      <div className="relative group">
        <select
          ...
          onChange={(e) =>
            handleFilter(e.target.value, currentYear, currentAuthor)
          }
          disabled={isPending}
        >
      ...
      <div className="relative group">
        <select
          ...
          onChange={(e) =>
            handleFilter(currentCategory, e.target.value, currentAuthor)
          }
          disabled={isPending}
        >
      ...
      <div className="relative group">
        <select
          ...
          onChange={(e) =>
            handleFilter(currentCategory, currentYear, e.target.value)
          }
          disabled={isPending}
        >
