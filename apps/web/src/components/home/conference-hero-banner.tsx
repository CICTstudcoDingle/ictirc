      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <ScrollAnimation direction="up" delay={0.2}>
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold mb-4 leading-[1.15] text-white tracking-tight">
                {data.name.split(" ").map((word, i) => (
                  <span
                    key={i}
                    className={i === 0 ? "text-gold" : "text-white"}
                  >
                    {word}{" "}
                  </span>
                ))}
            ...
            <ScrollAnimation direction="up" delay={0.5}>
              <div className="flex flex-col sm:flex-row gap-5 items-start">
                <Link href="/submit">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-maroon-600 hover:bg-maroon-700 text-white border border-maroon-500 shadow-[4px_4px_0px_0px_rgba(212,175,55,1)] transition-all hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-[2px_2px_0px_0px_rgba(212,175,55,1)]"
                  >
                ...
                <Link href="/archive">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-transparent border-2 border-white/20 text-white hover:bg-white/10 hover:border-white/40 transition-colors"
                  >
                    View Archive
                  </Button>
                </Link>
          ...
          <ScrollAnimation
            direction="up"
            delay={0.4}
            className="hidden lg:block relative w-full aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl border border-white/10 group"
          >
            <Image
