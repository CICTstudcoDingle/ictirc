          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none text-center">
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                <br />
                of Iloilo State University of Fisheries Science and Technology –
                Dingle Campus
              </p>

              <p className="text-gray-700 leading-relaxed mb-6">and</p>
              ...
              <p className="text-gray-700 leading-relaxed">
                in cooperation of{" "}
                <strong>International Linkages Affairs Office</strong> and{" "}
                <strong>Research and Development</strong> of ISUFST – Dingle
                Campus
              </p>
            </div>
          </div>
