  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white rounded-lg transition-colors"
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-72 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 z-[9999]">
            ...
            <div className="px-4 py-3 bg-gray-50 border-b border-gray-200">
              ...
              <p className="text-xs text-gray-700 truncate font-mono bg-white px-2 py-1.5 rounded border border-gray-200">
                {url}
              </p>
            </div>
