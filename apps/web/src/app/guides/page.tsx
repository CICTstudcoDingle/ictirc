        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          <ScrollAnimation direction="up">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Download official templates and guidelines to ensure your research
              paper meets ICTIRC submission standards.
            </p>
          </ScrollAnimation>
        </div>
      </section>
        ...
        {guides.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {guides.map((guide: any, index: number) => {
              ...
              const categorySlug =
                guide.guideCategory?.slug ||
                guide.category ||
                "manuscript-template";
              const categoryName =
                guide.guideCategory?.name || guide.category || "General";
              ...
              // Fallback or match
              const colorClass =
                categoryColors[normalizedSlug] || "bg-gray-100 text-gray-600";
                ...
                >
                  <Card className="hover:shadow-lg transition-shadow bg-white h-full">
                    <CardContent className="p-6">
                      {/* Category Icon */}
                      <div
                        className={`w-16 h-16 rounded-xl flex items-center justify-center mb-4 ${colorClass}`}
                      >
                      ...
                      {/* Category Badge */}
                      <span
                        className={`inline-block px-2 py-1 rounded-full text-xs font-medium mb-3 ${colorClass}`}
                      >
                        {categoryName}
                      </span>
            ...
            <div className="relative">
              ...
              <div className="space-y-8">
                {[
                  ...
                  >
                    <div
                      className={`relative flex items-center gap-6 ${idx % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse text-right"}`}
                    >
                      {/* Number Bubble */}
                      ...
                      {/* Text Content */}
                      <div
                        className={`flex-1 pl-12 md:pl-0 ${idx % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12 md:text-left"}`}
                      >
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  If you have questions about formatting or the submission
                  process, please contact the CICT Research Office at{" "}
                  <a
