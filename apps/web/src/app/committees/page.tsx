...
export const metadata = {
  ...
  description:
    "Meet the organizing committee of the 2026 2nd International Research Conference in Information Communications Technology",
};
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-[#4a0000] to-gray-900 py-12 md:py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            2026 2nd International Research Conference in Information
            Communications Technology
          </p>
          <p className="text-gray-400 mt-2">March 3 – 4, 2026</p>
        </div>
      </section>
