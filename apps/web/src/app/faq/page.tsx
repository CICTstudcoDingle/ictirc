...
export const metadata: Metadata = {
  ...
  description:
    "Common questions about ISSN, paper submission, review process, and publication with IRJICT.",
};
  ...
  const faqs = [
    {
      ...
      answer:
        "ISSN: 2960-3773 is the International Standard Serial Number of IRJICT (International Research Journal for Information and Communications Technology).",
    },
    {
      question: "Can I submit more than one paper for the same issue?",
      answer:
        "Yes, you can submit more than one paper for the same issue on IRJICT.",
    },
    {
      question: "How can I submit my manuscript at IRJICT?",
      answer:
        "You can submit your manuscript or paper to the IRJICT through online paper submission or on Email editor@irjict.com.",
    },
    {
      question:
        "How much time does IRJICT take in the manuscript or paper review process?",
      answer:
        "The editorial board is highly committed to the quick review process of the paper. The review process takes the maximum of 15-20 working days.",
    },
    {
      question: "What is the frequency of publication on IRJICT?",
      answer:
        "IRJICT publish journal two times a year. It publishes two time in a year.",
    },
    {
    ...
    {
      question:
        "What are the benefits of publishing paper on open access journal?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Download the copyright transfer form and submit at editor@irjict.com.",
    },
    {
      question:
        "Does there any restriction for the number of pages and fee for extra pages?",
      answer:
        "Maximum 10 pages are allowed in a paper. If it exceeds more than 10 pages, you are advice to revised your paper to reduce the number of pages based on the maximum number of pages required.",
    },
    {
      question: "How does the review process work?",
      answer:
        "The review of articles is done through a double blind peer review. All the articles received by IRJICT (International Research Journal for Information and Communications Technology) are sending to Review Committee after deleting the name of the author to have an unbiased opinion about the research.",
    },
    {
