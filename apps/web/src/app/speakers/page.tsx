...
import { Mic2, MapPin, ArrowRight, Calendar, ExternalLink } from "lucide-react";
import { prisma } from "@ictirc/database";
import { CircuitBackground } from "@ictirc/ui";

export const metadata: Metadata = {
  title: "Keynote Speakers | ICTIRC",
  description:
    "Meet the distinguished keynote speakers sharing insights and innovations in Information and Communications Technology at ICTIRC conferences.",
};

export default async function SpeakersPage() {
  // Prefer the active conference, fall back to the latest published one
  const conference =
    ...
    <div className="pt-14 md:pt-16 min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-[#800000] via-[#4a0000] to-[#800000] overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 text-white/80 rounded-full px-4 py-1.5 mb-6 text-sm font-semibold">
            <Mic2 className="w-4 h-4" />
            Distinguished Keynote Speakers
          </div>
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Meet the <span className="text-gold">Speakers</span>
          </h1>
          ...
          {conference && (
            <Link
              ...
              className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-xl px-5 py-3 transition-colors group"
            >
