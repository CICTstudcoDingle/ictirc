...
export const metadata = {
  ...
  description:
    "Organizations and institutions supporting the 2026 2nd International Research Conference in Information Communications Technology",
};
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-[#4a0000] to-gray-900 py-12 md:py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Organizations supporting the advancement of ICT research and
            innovation
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 hover:shadow-xl transition-shadow">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-600 mb-4">Malang, Indonesia</p>
          ...
          <div className="relative bg-gradient-to-br from-maroon to-red-900 rounded-2xl shadow-2xl p-8 md:p-12 text-center text-white overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-red-100 mb-8 max-w-2xl mx-auto">
                Support the advancement of ICT research and innovation by
                partnering with us for the 2026 IRCICT conference.
              </p>
              <a
                href="/about/#contact"
